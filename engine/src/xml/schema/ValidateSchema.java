...
public class ValidateSchema {
    ...
    public void noIdenticalCustomersIds(List<SDMCustomer> xmlCustomers) throws IllegalArgumentException{
        List<Integer> xmlStoresId = xmlCustomers.stream().map(SDMCustomer::getId).collect(Collectors.toList());
        if (!noIdenticalIds(xmlStoresId)) {
            throw new IllegalArgumentException("Same Customer Id define twice in market");
        }
    }
